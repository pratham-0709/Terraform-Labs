...
**** NOTE :- When performing this Lab try to perform mannualy by running on EC2 step by step sometimes there might be issues occuring with respect to packages and their versions. **